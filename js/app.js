...
// 全选成人资源按钮的事件处理函数（修复版）
function selectAllNonNormalAPIs() {
    const checkboxes = document.querySelectorAll('.api-adult');
    checkboxes.forEach(checkbox => {
        checkbox.checked = true;
    });
    updateSelectedAPIs(); // 更新选中的API列表
    checkAdultAPIsSelected(); // 检查成人资源选中状态并更新过滤器
}
...
function setupEventListeners() {
    ...
    // 添加toggleSettings的事件绑定（假设设置按钮存在）
